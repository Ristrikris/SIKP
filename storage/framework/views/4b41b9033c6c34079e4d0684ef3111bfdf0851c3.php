  ...
  <div class="row">
    ...
    <form action="/mhs/insertSuratKet" method="POST" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        <input type="lembaga" class="form-control" id="lembaga" required="required">
      </div>
      ...
      <div class="form-group">
        <label for="exampleFormControlFile1">Dokumen Pengajuan Surat Keterangan (PDF Scan) :</label>
...
<?php echo $__env->make('sikp.layout.masterMhs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sikp_fix\resources\views/sikp/Mahasiswa/suratKet.blade.php ENDPATH**/ ?>