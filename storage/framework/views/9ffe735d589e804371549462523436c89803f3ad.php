		...
		<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			  <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
						<a class="nav-link" href="<?php echo e(URL::to('/')); ?>/sikp/jadwalUjian"> <i class="fa fa-calendar-o"></i>Jadwal Ujian</strong></a>
				</ul>
...
</html><?php /**PATH D:\xampp\htdocs\sikp_fix\resources\views/sikp/layout/mahasiswaLayout.blade.php ENDPATH**/ ?>