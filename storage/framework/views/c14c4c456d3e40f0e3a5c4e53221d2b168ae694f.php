        ...
        <div class="list-group list-group-flush">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                ...
                <a class="dropdown-item" href="<?php echo e(URL::to('/')); ?>/sikp/regis_kp">Registrasi Pra KP</a>
                <a class="dropdown-item" href="<?php echo e(URL::to('/')); ?>/sikp/regis_pra_kp">Registrasi KP</a>
              </div>
        </div>
        <a href="<?php echo e(URL::to('/')); ?>/sikp/koor_bimbingan_kp" class="list-group-item list-group-item-action bg-light">Daftar Bimbingan KP</a>
        <a href="<?php echo e(URL::to('/')); ?>/sikp/koor_ujian_kp" class="list-group-item list-group-item-action bg-light">Daftar Ujian KP</a>
        </div>
        <!-- /#sidebar-wrapper -->
        <!-- Page Content -->
...
</html><?php /**PATH C:\xampp1\htdocs\sikp_fix\resources\views/sikp/layout/koorLayout.blade.php ENDPATH**/ ?>