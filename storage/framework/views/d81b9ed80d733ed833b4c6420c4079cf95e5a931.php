...
<body>
    ...
    <div class="login-box">
        <img src="<?php echo e(URL::to('/')); ?>/logo/warning.png" width="140" height="140" class="login-logo" alt="">
        <br>
        <div class="login-box-body">
            <p class="login-box-msg">Silahkan Login Kembali Menggunakan Email Yang Sudah Terdaftar Atau Hubungi Koordinator KP </p>
            <a class="btn btn-lg btn-danger btn-block" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
...
</html><?php /**PATH C:\xampp1\htdocs\sikp__\resources\views/logout.blade.php ENDPATH**/ ?>