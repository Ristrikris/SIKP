...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    ...
    <body>
        ...
        <a href="<?php echo e(URL::to('/')); ?>/sikp/koor_ujian_kp" class="list-group-item list-group-item-action bg-light">Daftar Ujian KPP</a>
        </div>
        <!-- /#sidebar-wrapper -->
        <!-- Page Content -->
...
</html><?php /**PATH D:\SIKP\web\resources\views/sikp/layout/koorLayout.blade.php ENDPATH**/ ?>