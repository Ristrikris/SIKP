...
<div class="row">
  <div class="col-md-6">
    ...
    <form action="/mhs/insertPraKp" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
        <label for="exampleFormControlFile1">Dokumen Pengajuan Pra KP (PDF Scan) :</label>
  ...
  <div class="col-md-6">
    <div class="box-header">
      <h4 class="box-title">Daftar Pengajuan Pra KP</h4>
    </div>
...
<?php echo $__env->make('sikp.layout.masterMhs', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\sikp\resources\views/sikp/mhs/pengajuanPraKp.blade.php ENDPATH**/ ?>