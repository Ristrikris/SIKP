        ...
        <div class="list-group list-group-flush">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="<?php echo e(URL::to('/')); ?>/sikp/bimbingan_kp">Daftar Bimbingan KP</a>
                <a class="dropdown-item" href="<?php echo e(URL::to('/')); ?>/sikp/ujian_kp">Jadwal Ujian Mahasiswa</a>
              </div>
        </div>
        </div>
        <!-- /#sidebar-wrapper -->
...
</html><?php /**PATH C:\xampp1\htdocs\sikp_fix\resources\views/sikp/layout/dosenLayout.blade.php ENDPATH**/ ?>