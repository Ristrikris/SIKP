...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        @if(auth()->user()->photo)
        <br><img src="{{ auth()->user()->photo }}" alt="photo" height="100" width="100" class="img-thumbnail"><br><br>
        @endif
        </div>
        <div class="d-flex justify-content-center">
        ...
        <div class="list-group list-group-flush">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              ...
              <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{ URL::to('/') }}/sikp/suratKet">Surat Pengajuan KP</a>
                <a class="dropdown-item" href="{{ URL::to('/') }}/sikp/pengajuanPraKp">Pengajuan Pra KP</a>
                <a class="dropdown-item" href="{{ URL::to('/') }}/sikp/pengajuanKp">Pengajuan KP</a>
              </div>
            </li>
            <a class="list-group-item list-group-item-action bg-light"href="{{ URL::to('/') }}/sikp/jadwalUjian">Jadwal Ujian</a>
        </div>
        </div>
        <!-- /#sidebar-wrapper -->
        <!-- Page Content -->
