		...
		<nav class="navbar navbar-icon-top navbar-expand-lg navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
			  <ul class="navbar-nav mr-auto">
				...
				<li class="nav-item">
				  	<a class="nav-link" href="{{ URL::to('/') }}/sikp/bimbingan_kp"> <i class="fa fa-list-alt"></i>Daftar Bimbingan KP</strong></a>
				<li class="nav-item">
				  	<a class="nav-link" href="{{ URL::to('/') }}/sikp/ujian_kp"> <i class="fa fa-calendar-o"></i>Jadwal Ujian</a>
